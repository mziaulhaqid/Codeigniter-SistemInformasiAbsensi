<div class="row justify-content-center">
  <div class="col-md-10">
    <div class="card card-primary">
      ...
      foreach ($show as $i) {
        ?>
        <form class="form-horizontal" action="<?= site_url('admin/aksi_update_pegawai')?>" enctype="multipart/form-data" method="post">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm">
                  <select class="form-control" name="devisi" required="">
                    ...
                    <?php
                    foreach ($devisi as $ii) {
                      if ($i->kode_devisi == $ii->kode_devisi){
                        $selected = "selected";
                      }
                      ?>
                      <option value="<?= $i->kode_devisi?>" selected="<?= $selected?>" ><?= $ii->nama_devisi?></option>
                      <?php
                    }
                    ?>
                  </select>
