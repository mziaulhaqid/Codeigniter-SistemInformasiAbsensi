       ...
       <div class="col-md-9">
         ...
         foreach ($show as $i) {
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?= base_url('pegawai/Aksi_Update_Pegawai')?>" method="post">
              <div class="card-body">
                <?php
                if(!empty($i->profile)){
            ...
            <div class="card-footer">
              <a href="<?= base_url('admin/edit_pegawai/'.$i->nip.'')?>" class="btn btn-primary">Edit</a>
